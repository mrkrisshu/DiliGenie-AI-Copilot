...
export const Component = ({ size = 180, text = "Generating", embedded = false }) => {
        ...
        @keyframes loaderCircle {
          0% {
            ...
            box-shadow:
              ...
              0 36px 36px 0 #0284c7 inset,
              0 0 3px 1.2px rgba(56, 189, 248, 0.3),
              0 0 6px 1.8px rgba(14, 165, 233, 0.2);
          }
          50% {
            transform: rotate(270deg);
            box-shadow:
              0 6px 12px 0 #60a5fa inset,
              0 12px 6px 0 #0ea5e9 inset,
              0 24px 36px 0 #0284c7 inset,
              0 0 3px 1.2px rgba(56, 189, 248, 0.3),
              0 0 6px 1.8px rgba(14, 165, 233, 0.2);
          }
          100% {
