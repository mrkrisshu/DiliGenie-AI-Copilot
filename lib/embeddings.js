...
async function generateHuggingFaceEmbedding(text) {
  ...
  try {
    ...
    // Models for 1024 dimensions:
    // - mixedbread-ai/mxbai-embed-large-v1 (1024d) - excellent quality, FREE
    // - BAAI/bge-large-en-v1.5 (1024d) - high quality
    // Models for 384 dimensions (faster but need padding):
    // - BAAI/bge-small-en-v1.5 (384d) - good quality
    const model = "mixedbread-ai/mxbai-embed-large-v1"; // Native 1024d!
